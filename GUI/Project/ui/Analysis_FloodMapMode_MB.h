...
#define  FMMODEMB_STRING_16               9       /* control type: string, callback function: (none) */
#define  FMMODEMB_COMMANDBUTTON_11        10      /* control type: command, callback function: (none) */
#define  FMMODEMB_STRING_14               11      /* control type: string, callback function: (none) */
#define  FMMODEMB_COMMANDBUTTON_10        12      /* control type: command, callback function: (none) */
#define  FMMODEMB_STRING_12               13      /* control type: string, callback function: (none) */
#define  FMMODEMB_COMMANDBUTTON_9         14      /* control type: command, callback function: (none) */
#define  FMMODEMB_STRING_11               15      /* control type: string, callback function: (none) */
#define  FMMODEMB_COMMANDBUTTON_8         16      /* control type: command, callback function: (none) */
#define  FMMODEMB_COMMANDBUTTON_7         17      /* control type: command, callback function: (none) */
#define  FMMODEMB_COMMANDBUTTON_6         18      /* control type: command, callback function: (none) */
...
#define  FMMODEMB_TREE                    30      /* control type: tree, callback function: (none) */
