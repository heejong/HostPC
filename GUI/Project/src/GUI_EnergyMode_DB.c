...
### FILE REFERENCES
	...
	- "GUI_EnergyMode_DB.h" - provides connection to "GUI_EnergyMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "GUI_EnergyMode_DB.h" must be added to the include path.
