...
### FILE REFERENCES
	...
	- "Analysis_TestMode1.h" - provides connection to "Analysis_TestMode2.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "Analysis_TestMode2.h" must be added to the include path.
