...
### FILE REFERENCES
	...
	- "GUI_TimeMode_MB.h" - provides connection to "GUI_TimeMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "GUI_TimeMode_MB.h" must be added to the include path.
