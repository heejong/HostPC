//==============================================================================
/** @file Analysis_TestMode_MB.c                          
    @brief This file provides the functions needed for the test mode MB screen.
...
### FILE REFERENCES
	...
	- "Analysis_TestMode_MB.h" - provides connection to "Analysis_TestMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "Analysis_TestMode_MB.h" must be added to the include path.
