...
### FILE REFERENCES
	...
	- "Analysis_UserDefinedMode_MB.h" - provides connection to "Analysis_UserDefinedMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "Analysis_UserDefinedMode_MB.h" must be added to the include path.
