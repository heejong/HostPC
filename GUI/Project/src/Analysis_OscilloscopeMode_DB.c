//==============================================================================
/** @file Analysis_OscilloscopeMode_DB.c                          
...
### FILE REFERENCES
	...
	- "Analysis_OscilloscopeMode_DB.h" - provides connection to "Analysis_OscilloscopeMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "Analysis_OscilloscopeMode_DB.h" must be added to the include path.
