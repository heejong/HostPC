...
### FILE REFERENCES
	...
	- "GUI_UserDefinedMode_DB.h" - provides connection to "GUI_UserDefinedMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "GUI_UserDefinedMode_DB.h" must be added to the include path.
