...
### FILE REFERENCES
	...
	- "GUI_EnergyMode_MB.h" - provides connection to "GUI_EnergyMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "GUI_EnergyMode_MB.h" must be added to the include path.
