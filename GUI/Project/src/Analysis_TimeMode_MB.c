//==============================================================================
/** @file Analysis_TimeMode_MB.c                          
    @brief This file provides the functions needed for the time mode MB screen.
...
### FILE REFERENCES
	...
	- "Analysis_TimeMode_MB.h" - provides connection to "Analysis_TimeMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "Analysis_TimeMode_MB.h" must be added to the include path.
