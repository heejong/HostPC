...
### FILE REFERENCES
	...
	- "Analysis_EnergyMode.h" - provides connection to "Analysis_EnergyMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "Analysis_EnergyMode.h" must be added to the include path.
...
### EXTERNAL REFERENCES
    - QuitUserInterface() - <userint.h> 
	- SetPanelAttribute () - <userint.h> 
	- GetNumListItems() - <userint.h>
	- InsertTreeItem() - <userint.h>
	- SetTreeItemAttribute() - <userint.h>
	- GetTreeItemFromTag() - <userint.h>
	- strcat() - <ansi_c.h>
	- strcpy() - <ansi_c.h>  
	- sprintf() - <ansi_c.h> 
...
### EXTERNAL REFERENCES
	- GetTreeItemTag() - <userint.h>
	- OpenPETTreeInit() - "UI_Common.h"
	- strcpy() - <ansi_c.h> 
	- isdigit() - <ansi_c.h> 
	- StackPeek() - "UI_Common.h"
	- StackPop() - "UI_Common.h"
	- StackPush() - "UI_Common.h"
	- HidePanel() - <userint.h>
	- DisplayPanel() - <userint.h>
...
### EXTERNAL REFERENCES
	- GetCtrlIndex() - <userint.h>
	- SetCtrlAttribute() - <userint.h>
