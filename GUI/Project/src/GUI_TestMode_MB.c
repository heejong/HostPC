...
### FILE REFERENCES
	...
	- "GUI_TestMode_MB.h" - provides connection to "GUI_TestMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "GUI_TestMode_MB.h" must be added to the include path.
