//==============================================================================
/** @file GUI_TestMode_DUC.c                          
    @brief This file provides the functions needed for the test mode DUC screen.
...
### FILE REFERENCES
	...
	- "GUI_TestMode_DUC.h" - provides connection to "GUI_TestMode.uir"
...
### ASSUMPTIONS, CONSTRAINTS, RESTRICTIONS
	To call functions and structures in this file "GUI_TestMode_DUC.h" must be added to the include path.
		...
		void *callbackData, int eventData1, int eventData2)
{
	switch (event)
	{
		case EVENT_COMMIT:
			...
			switch (control)
			{
				case TESTMODEDU_BUTTON_0:
					current_location.DUC = 0;
					break;
				case TESTMODEDU_BUTTON_1:
					current_location.DUC = 1;
					break;
				case TESTMODEDU_BUTTON_2:
					current_location.DUC = 2;
					break;
				case TESTMODEDU_BUTTON_3:
					current_location.DUC = 3;
					break;
				case TESTMODEDU_BUTTON_4:
					current_location.DUC = 4;
					break;
				case TESTMODEDU_BUTTON_5:
					current_location.DUC = 5;
					break;
				case TESTMODEDU_BUTTON_6:
					current_location.DUC = 6;
					break;
				case TESTMODEDU_BUTTON_7:
